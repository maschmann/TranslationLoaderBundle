...
class AppTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'asm_translation_loader.event_dispatcher' => 'getAsmTranslationLoader_EventDispatcherService',
            'asm_translation_loader.file_loader_resolver' => 'getAsmTranslationLoader_FileLoaderResolverService',
            'asm_translation_loader.translation.entity_manager' => 'getAsmTranslationLoader_Translation_EntityManagerService',
            'asm_translation_loader.translation_history_manager' => 'getAsmTranslationLoader_TranslationHistoryManagerService',
            'asm_translation_loader.translation_manager' => 'getAsmTranslationLoader_TranslationManagerService',
            'asm_translation_loader.translation_manager_resource' => 'getAsmTranslationLoader_TranslationManagerResourceService',
    ...
    /**
     * Gets the 'asm_translation_loader.event_dispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAsmTranslationLoader_EventDispatcherService()
    {
        return $this->services['asm_translation_loader.event_dispatcher'] = new \Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher($this);
    }

    /**
     * Gets the 'asm_translation_loader.file_loader_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Asm\TranslationLoaderBundle\Translation\FileLoaderResolver A Asm\TranslationLoaderBundle\Translation\FileLoaderResolver instance.
     */
    protected function getAsmTranslationLoader_FileLoaderResolverService()
    {
        return $this->services['asm_translation_loader.file_loader_resolver'] = new \Asm\TranslationLoaderBundle\Translation\FileLoaderResolver();
    }

    /**
     * Gets the 'asm_translation_loader.translation_history_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Asm\TranslationLoaderBundle\Doctrine\TranslationHistoryManager A Asm\TranslationLoaderBundle\Doctrine\TranslationHistoryManager instance.
     */
    protected function getAsmTranslationLoader_TranslationHistoryManagerService()
    {
        return $this->services['asm_translation_loader.translation_history_manager'] = new \Asm\TranslationLoaderBundle\Doctrine\TranslationHistoryManager($this->get('asm_translation_loader.translation.entity_manager'), 'Asm\\TranslationLoaderBundle\\Entity\\TranslationHistory');
    }

    /**
     * Gets the 'asm_translation_loader.translation_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Asm\TranslationLoaderBundle\Doctrine\TranslationManager A Asm\TranslationLoaderBundle\Doctrine\TranslationManager instance.
     */
    protected function getAsmTranslationLoader_TranslationManagerService()
    {
        return $this->services['asm_translation_loader.translation_manager'] = new \Asm\TranslationLoaderBundle\Doctrine\TranslationManager($this->get('asm_translation_loader.translation.entity_manager'), 'Asm\\TranslationLoaderBundle\\Entity\\Translation', $this->get('asm_translation_loader.event_dispatcher'));
    }

    /**
     * Gets the 'asm_translation_loader.translation_manager_resource' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Asm\TranslationLoaderBundle\Config\Resource\TranslationManagerResource A Asm\TranslationLoaderBundle\Config\Resource\TranslationManagerResource instance.
     */
    protected function getAsmTranslationLoader_TranslationManagerResourceService()
    {
        return $this->services['asm_translation_loader.translation_manager_resource'] = new \Asm\TranslationLoaderBundle\Config\Resource\TranslationManagerResource($this->get('translation.loader.db'));
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer(new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), ($this->targetDirs[2].'/Resources')), $this->get('templating.locator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    {
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getTranslation_LoaderService()
    {
        ...
        $instance->addLoader('db', $this->get('translation.loader.db'));
    ...
    /**
     * Gets the 'translation.loader.db' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Asm\TranslationLoaderBundle\Translation\DatabaseLoader A Asm\TranslationLoaderBundle\Translation\DatabaseLoader instance.
     */
    protected function getTranslation_Loader_DbService()
    {
        return $this->services['translation.loader.db'] = new \Asm\TranslationLoaderBundle\Translation\DatabaseLoader($this->get('asm_translation_loader.translation_manager'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json'), 'translation.loader.db' => array(0 => 'db')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('FrameworkKernelSecret');
    }

    /**
     * Gets the 'asm_translation_loader.translation.entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAsmTranslationLoader_Translation_EntityManagerService()
    {
        return $this->services['asm_translation_loader.translation.entity_manager'] = $this->get('doctrine')->getManager('default');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AsmTranslationLoaderBundle' => 'Asm\\TranslationLoaderBundle\\AsmTranslationLoaderBundle',
            ),
            ...
            'kernel.secret' => 'FrameworkKernelSecret',
            ...
            'asm_translation_loader.translation_loaders' => array(

            ),
            'asm_translation_loader.database.entity_manager' => 'default',
            'asm_translation_loader.event_dispatcher.class' => 'Symfony\\Component\\EventDispatcher\\ContainerAwareEventDispatcher',
            'asm_translation_loader.resources' => array(

            ),
            'asm_translation_loader.translation_manager_resource.class' => 'Asm\\TranslationLoaderBundle\\Config\\Resource\\TranslationManagerResource',
            'asm_translation_loader.translation_manager.class' => 'Asm\\TranslationLoaderBundle\\Doctrine\\TranslationManager',
            'asm_translation_loader.translation_history_manager.class' => 'Asm\\TranslationLoaderBundle\\Doctrine\\TranslationHistoryManager',
            'asm_translation_loader.model.translation.class' => 'Asm\\TranslationLoaderBundle\\Entity\\Translation',
            'asm_translation_loader.model.translation_history.class' => 'Asm\\TranslationLoaderBundle\\Entity\\TranslationHistory',
            'asm_translation_loader.file_loader_resolver.class' => 'Asm\\TranslationLoaderBundle\\Translation\\FileLoaderResolver',
